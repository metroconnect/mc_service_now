...
// ==/UserScript==
	...
	else if (iframeHref.match(/^https?:\/\/dimensiondatacygnus.service-now.com\/nav.do/)) { 
	...
	else if (thisURL.match(/^https?:\/\/dimensiondatacygnus.service-now.com\/(incident|u_request|change_request).do/)){ 
	...
	//  -----------------------------------------------------
   		...
   		var incidentRequest = "";
    		...
    		if (thisURL.match(/^https?:\/\/dimensiondatacygnus.service-now.com\/incident.do/)) { 
        		incidentRequest = "incident";
    		}
    		else if (thisURL.match(/^https?:\/\/dimensiondatacygnus.service-now.com\/u_request.do/)) {
     			incidentRequest = "request";
    		}
    		else if (thisURL.match(/^https?:\/\/dimensiondatacygnus.service-now.com\/change_request.do/)) {
	...
	else if (thisURL.match(/^https?:\/\/dimensiondatacygnus.service-now.com\/task_time_worked.do/)){ 
	...
	else if (thisURL.match(/^https?:\/\/dimensiondatacygnus.service-now.com\/u_reminder.do/)){
